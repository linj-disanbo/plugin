...
function zkspot_setPubKey() {
    ...
    rawData=$(${CLI} zkspot pubkey -a "${ZKSYNC_ACCOUNT_3}")
    echo "${rawData}"
...
function zkspot_withdraw() {
    ...
    rawData=$(${CLI} zkspot withdraw -t "${TOKENID_0}" -a 100000000 -i "${ZKSYNC_ACCOUNT_3}")
    echo "${rawData}"
...
function zkspot_treeToContract() {
    ...
    rawData=$(${CLI} zkspot tree2contract -t "${TOKENID_0}" -a 10000000000000000000 --accountId "${ZKSYNC_ACCOUNT_3}")
    echo "${rawData}"
...
function zkspot_contractToTree() {
    ...
    chain33Addr=$(${CLI} zkspot l2addr -k 6da92a632ab7deb67d38c0f6560bcfed28167998f6496db64c258d5e8393a81b)
    rawData=$(${CLI} zkspot contract2tree -t "${TOKENID_0}" -a 1000000000000000000 --accountId "${ZKSYNC_ACCOUNT_3}")
    echo "${rawData}"
    ...
    rawData=$(${CLI} zkspot deposit -t "${TOKENID_1}" -a 1000000000 -e abcd68033A72978C1084E2d44D1Fa06DdC4A2d57 -c "$chain33Addr" -i 1)
    echo "${rawData}"
...
function zkspot_transfer() {
    ...
    rawData=$(${CLI} zkspot transfer -t "${TOKENID_0}" -a 100000000 --accountId "${ZKSYNC_ACCOUNT_3}" --toAccountId "${ZKSYNC_ACCOUNT_4}")
    echo "${rawData}"
...
function zkspot_transferToNew() {
    ...
    rawData=$(${CLI} zkspot transfer2new -t "${TOKENID_0}" -a 100000000 --accountId "${ZKSYNC_ACCOUNT_3}" -e 12a0E25E62C1dBD32E505446062B26AECB65F028 -c "$chain33Addr")
    echo "${rawData}"
...
function zkspot_forceExit() {
    ...
    rawData=$(${CLI} zkspot pubkey -a "${ZKSYNC_ACCOUNT_4}")
    echo "${rawData}"
    ...
    rawData=$(${CLI} zkspot forceexit -t "${TOKENID_0}" -a "${ZKSYNC_ACCOUNT_4}")
    echo "${rawData}"
...
function zkspot_fullExit() {
    ...
    rawData=$(${CLI} zkspot fullexit -t "${TOKENID_0}" -a 4 -i 2)
    echo "${rawData}"
