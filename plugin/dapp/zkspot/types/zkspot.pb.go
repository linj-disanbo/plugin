...
func (*ZksyncAction1) Descriptor() ([]byte, []int) {
	return fileDescriptor_zkspot_42616e013cfeabc5, []int{0}
}
...
func (m *ZksyncAction1) GetNftOrder() *SpotNftOrder {
	if x, ok := m.GetValue().(*ZksyncAction1_NftOrder); ok {
		return x.NftOrder
	}
	return nil
}

func (m *ZksyncAction1) GetNftTakerOrder() *SpotNftTakerOrder {
	if x, ok := m.GetValue().(*ZksyncAction1_NftTakerOrder); ok {
...
func _ZksyncAction1_OneofUnmarshaler(msg proto.Message, tag, wire int, b *proto.Buffer) (bool, error) {
	...
	case 207: // value.entrustRevokeOrder
		...
		return true, err
	case 300: // value.nftOrder
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SpotNftOrder)
		err := b.DecodeMessage(msg)
		m.Value = &ZksyncAction1_NftOrder{msg}
		return true, err
	case 301: // value.nftTakerOrder
		if wire != proto.WireBytes {
			return true, proto.ErrInternalBadWireType
		}
		msg := new(SpotNftTakerOrder)
		err := b.DecodeMessage(msg)
		m.Value = &ZksyncAction1_NftTakerOrder{msg}
		return true, err
	default:
		return false, nil
	}
...
func (*ZkTransferWithFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_zkspot_42616e013cfeabc5, []int{1}
}
...
func init() { proto.RegisterFile("zkspot.proto", fileDescriptor_zkspot_42616e013cfeabc5) }

var fileDescriptor_zkspot_42616e013cfeabc5 = []byte{
	// 779 bytes of a gzipped FileDescriptorProto
	,
}
