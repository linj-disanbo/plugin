...
func (*ZksyncAction1) Descriptor() ([]byte, []int) {
	return fileDescriptor_zksync1_22c913fedcb55888, []int{0}
}
...
func (*ZkTransferWithFee) Descriptor() ([]byte, []int) {
	return fileDescriptor_zksync1_22c913fedcb55888, []int{1}
}
...
func init() { proto.RegisterFile("zksync1.proto", fileDescriptor_zksync1_22c913fedcb55888) }

var fileDescriptor_zksync1_22c913fedcb55888 = []byte{
	// 673 bytes of a gzipped FileDescriptorProto
	,
}
